    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desciption', models.TextField(blank=True, help_text='Not Required', verbose_name='description')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Required', max_length=200, verbose_name='Product Name')),
                ('is_active', models.BooleanField(default=True)),
            ],
            options={
